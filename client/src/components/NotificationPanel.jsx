...
const data = [
  {
    ...
    text: "New task has been assgined to you and 2 others. The task priority is set a normal priority, so check and act accordincly. The task date is Thu Feb 29 2024. Thank you!!!",
    task: null,
    notiType: "alert",
    isRead: [],
    createdAt: "2024-02-09T05:45:24.352Z",
  ...
  },
  {
    ...
    text: "New task has been assgined to you and 2 others. The task priority is set a normal priority, so check and act accordincly. The task date is Fri Feb 09 2024. Thank you!!!",
    task: {
    ...
    <>
      <Popover className="relative">
        <Popover.Button className="inline-flex items-center outline-none">
          <div className="w-8 h-8 items-center justify-center text-gray-800 dark:text-white relative">
